# 🛡️ Security Intelligence Brief — 2026-09-21

**Generated**: 2026-09-21T11:19:32.395087
**Packages Audited**: 10
...
| **GHSA-2xp9-vwfh-vxw4** | `next` | npm | Next.js: Unauthenticated Remote Code Execution in Image Optimization API when AV... | [Advisory](https://osv.dev/vulnerability/GHSA-2xp9-vwfh-vxw4) |
...
| **CVE-2021-32677** | `fastapi` | PyPI | FastAPI is a web framework for building APIs with Python 3.6+ based on standard ... | [Advisory](https://osv.dev/vulnerability/PYSEC-2021-100) |
| **CVE-2024-24762** | `fastapi` | PyPI | FastAPI is a web framework for building APIs with Python 3.8+ based on standard ... | [Advisory](https://osv.dev/vulnerability/PYSEC-2024-38) |
